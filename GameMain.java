...
import tetris.BasicGenerator;
import tetris.BlockGame;

import tetris.api.IGame;
import tetris.impl.BasicPlayLevel;
//import tetris.example.SampleGame;
import tetris.example.SampleGenerator;
...
public class GameMain
{
  ...
  private static void create()
  {
    ...
    //IGame game = new BlockGame(new BasicGenerator());
